...
pub enum CgIcon {
    ...
    #[cfg(CgArrowAlignV)]
    CgArrowAlignV,
    #[cfg(CgArrowBottomLeft)]
    CgArrowBottomLeft,
    #[cfg(CgArrowBottomLeftO)]
    CgArrowBottomLeftO,
    #[cfg(CgArrowBottomLeftR)]
    CgArrowBottomLeftR,
    #[cfg(CgArrowBottomRight)]
    CgArrowBottomRight,
    #[cfg(CgArrowBottomRightO)]
    CgArrowBottomRightO,
    #[cfg(CgArrowBottomRightR)]
    CgArrowBottomRightR,
    #[cfg(CgArrowDown)]
    CgArrowDown,
    #[cfg(CgArrowDownO)]
    ...
    #[cfg(CgArrowLongDown)]
    CgArrowLongDown,
    #[cfg(CgArrowLongDownC)]
    CgArrowLongDownC,
    #[cfg(CgArrowLongDownE)]
    CgArrowLongDownE,
    #[cfg(CgArrowLongDownL)]
    CgArrowLongDownL,
    #[cfg(CgArrowLongDownR)]
    CgArrowLongDownR,
    #[cfg(CgArrowLongLeft)]
    CgArrowLongLeft,
    #[cfg(CgArrowLongLeftC)]
    CgArrowLongLeftC,
    #[cfg(CgArrowLongLeftE)]
    CgArrowLongLeftE,
    #[cfg(CgArrowLongLeftL)]
    CgArrowLongLeftL,
    #[cfg(CgArrowLongLeftR)]
    CgArrowLongLeftR,
    #[cfg(CgArrowLongRight)]
    CgArrowLongRight,
    #[cfg(CgArrowLongRightC)]
    CgArrowLongRightC,
    #[cfg(CgArrowLongRightE)]
    CgArrowLongRightE,
    #[cfg(CgArrowLongRightL)]
    CgArrowLongRightL,
    #[cfg(CgArrowLongRightR)]
    CgArrowLongRightR,
    #[cfg(CgArrowLongUp)]
    CgArrowLongUp,
    #[cfg(CgArrowLongUpC)]
    ...
    #[cfg(CgArrowTopRight)]
    CgArrowTopRight,
    #[cfg(CgArrowTopRightO)]
    CgArrowTopRightO,
    #[cfg(CgArrowTopRightR)]
    CgArrowTopRightR,
    #[cfg(CgArrowUp)]
    CgArrowUp,
    #[cfg(CgArrowUpO)]
    ...
    #[cfg(CgArrowsBreakeV)]
    CgArrowsBreakeV,
    #[cfg(CgArrowsExchange)]
    CgArrowsExchange,
    #[cfg(CgArrowsExchangeAlt)]
    CgArrowsExchangeAlt,
    #[cfg(CgArrowsExchangeAltV)]
    CgArrowsExchangeAltV,
    #[cfg(CgArrowsExchangeV)]
    CgArrowsExchangeV,
    #[cfg(CgArrowsExpandDownLeft)]
    CgArrowsExpandDownLeft,
    #[cfg(CgArrowsExpandDownRight)]
    CgArrowsExpandDownRight,
    #[cfg(CgArrowsExpandLeft)]
    CgArrowsExpandLeft,
    #[cfg(CgArrowsExpandLeftAlt)]
    CgArrowsExpandLeftAlt,
    #[cfg(CgArrowsExpandRight)]
    CgArrowsExpandRight,
    #[cfg(CgArrowsExpandRightAlt)]
    CgArrowsExpandRightAlt,
    #[cfg(CgArrowsExpandUpLeft)]
    CgArrowsExpandUpLeft,
    #[cfg(CgArrowsExpandUpRight)]
    CgArrowsExpandUpRight,
    #[cfg(CgArrowsH)]
    CgArrowsH,
    #[cfg(CgArrowsHAlt)]
    CgArrowsHAlt,
    #[cfg(CgArrowsMergeAltH)]
    CgArrowsMergeAltH,
    #[cfg(CgArrowsMergeAltV)]
    CgArrowsMergeAltV,
    #[cfg(CgArrowsScrollH)]
    CgArrowsScrollH,
    #[cfg(CgArrowsScrollV)]
    ...
    #[cfg(CgBorderRight)]
    CgBorderRight,
    #[cfg(CgBorderStyleDashed)]
    CgBorderStyleDashed,
    #[cfg(CgBorderStyleDotted)]
    CgBorderStyleDotted,
    #[cfg(CgBorderStyleSolid)]
    CgBorderStyleSolid,
    #[cfg(CgBorderTop)]
    CgBorderTop,
    #[cfg(CgBot)]
    ...
    #[cfg(CgCheckR)]
    CgCheckR,
    #[cfg(CgChevronDoubleDown)]
    CgChevronDoubleDown,
    #[cfg(CgChevronDoubleDownO)]
    CgChevronDoubleDownO,
    #[cfg(CgChevronDoubleDownR)]
    CgChevronDoubleDownR,
    #[cfg(CgChevronDoubleLeft)]
    CgChevronDoubleLeft,
    #[cfg(CgChevronDoubleLeftO)]
    CgChevronDoubleLeftO,
    #[cfg(CgChevronDoubleLeftR)]
    CgChevronDoubleLeftR,
    #[cfg(CgChevronDoubleRight)]
    CgChevronDoubleRight,
    #[cfg(CgChevronDoubleRightO)]
    CgChevronDoubleRightO,
    #[cfg(CgChevronDoubleRightR)]
    CgChevronDoubleRightR,
    #[cfg(CgChevronDoubleUp)]
    CgChevronDoubleUp,
    #[cfg(CgChevronDoubleUpO)]
    CgChevronDoubleUpO,
    #[cfg(CgChevronDoubleUpR)]
    CgChevronDoubleUpR,
    #[cfg(CgChevronDown)]
    CgChevronDown,
    #[cfg(CgChevronDownO)]
    ...
    #[cfg(CgCopyright)]
    CgCopyright,
    #[cfg(CgCornerDoubleDownLeft)]
    CgCornerDoubleDownLeft,
    #[cfg(CgCornerDoubleDownRight)]
    CgCornerDoubleDownRight,
    #[cfg(CgCornerDoubleLeftDown)]
    CgCornerDoubleLeftDown,
    #[cfg(CgCornerDoubleLeftUp)]
    CgCornerDoubleLeftUp,
    #[cfg(CgCornerDoubleRightDown)]
    CgCornerDoubleRightDown,
    #[cfg(CgCornerDoubleRightUp)]
    CgCornerDoubleRightUp,
    #[cfg(CgCornerDoubleUpLeft)]
    CgCornerDoubleUpLeft,
    #[cfg(CgCornerDoubleUpRight)]
    CgCornerDoubleUpRight,
    #[cfg(CgCornerDownLeft)]
    CgCornerDownLeft,
    #[cfg(CgCornerDownRight)]
    CgCornerDownRight,
    #[cfg(CgCornerLeftDown)]
    CgCornerLeftDown,
    #[cfg(CgCornerLeftUp)]
    CgCornerLeftUp,
    #[cfg(CgCornerRightDown)]
    CgCornerRightDown,
    #[cfg(CgCornerRightUp)]
    CgCornerRightUp,
    #[cfg(CgCornerUpLeft)]
    ...
    #[cfg(CgDisplayFlex)]
    CgDisplayFlex,
    #[cfg(CgDisplayFullwidth)]
    CgDisplayFullwidth,
    #[cfg(CgDisplayGrid)]
    CgDisplayGrid,
    #[cfg(CgDisplaySpacing)]
    CgDisplaySpacing,
    #[cfg(CgDistributeHorizontal)]
    CgDistributeHorizontal,
    #[cfg(CgDistributeVertical)]
    ...
    #[cfg(CgFormatHeading)]
    CgFormatHeading,
    #[cfg(CgFormatIndentDecrease)]
    CgFormatIndentDecrease,
    #[cfg(CgFormatIndentIncrease)]
    ...
    #[cfg(CgFormatLeft)]
    CgFormatLeft,
    #[cfg(CgFormatLineHeight)]
    CgFormatLineHeight,
    #[cfg(CgFormatRight)]
    CgFormatRight,
    #[cfg(CgFormatSeparator)]
    CgFormatSeparator,
    #[cfg(CgFormatSlash)]
    CgFormatSlash,
    #[cfg(CgFormatStrike)]
    ...
    #[cfg(CgFormatText)]
    CgFormatText,
    #[cfg(CgFormatUnderline)]
    CgFormatUnderline,
    #[cfg(CgFormatUppercase)]
    CgFormatUppercase,
    #[cfg(CgFramer)]
    CgFramer,
    #[cfg(CgGames)]
    ...
    #[cfg(CgPen)]
    CgPen,
    #[cfg(CgPentagonBottomLeft)]
    CgPentagonBottomLeft,
    #[cfg(CgPentagonBottomRight)]
    ...
    #[cfg(CgPentagonRight)]
    CgPentagonRight,
    #[cfg(CgPentagonTopLeft)]
    CgPentagonTopLeft,
    #[cfg(CgPentagonTopRight)]
    CgPentagonTopRight,
    #[cfg(CgPentagonUp)]
    CgPentagonUp,
    #[cfg(CgPerformance)]
    ...
    #[cfg(CgPlayListCheck)]
    CgPlayListCheck,
    #[cfg(CgPlayListRemove)]
    CgPlayListRemove,
    #[cfg(CgPlayListSearch)]
    CgPlayListSearch,
    #[cfg(CgPlayPause)]
    CgPlayPause,
    #[cfg(CgPlayPauseO)]
    ...
    #[cfg(CgPlayTrackNext)]
    CgPlayTrackNext,
    #[cfg(CgPlayTrackNextO)]
    CgPlayTrackNextO,
    #[cfg(CgPlayTrackNextR)]
    CgPlayTrackNextR,
    #[cfg(CgPlayTrackPrev)]
    CgPlayTrackPrev,
    #[cfg(CgPlayTrackPrevO)]
    CgPlayTrackPrevO,
    #[cfg(CgPlayTrackPrevR)]
    CgPlayTrackPrevR,
    #[cfg(CgPlug)]
    CgPlug,
    #[cfg(CgPocket)]
    ...
    #[cfg(CgPullClear)]
    CgPullClear,
    #[cfg(CgPushChevronDown)]
    CgPushChevronDown,
    #[cfg(CgPushChevronDownO)]
    CgPushChevronDownO,
    #[cfg(CgPushChevronDownR)]
    CgPushChevronDownR,
    #[cfg(CgPushChevronLeft)]
    CgPushChevronLeft,
    #[cfg(CgPushChevronLeftO)]
    CgPushChevronLeftO,
    #[cfg(CgPushChevronLeftR)]
    CgPushChevronLeftR,
    #[cfg(CgPushChevronRight)]
    CgPushChevronRight,
    #[cfg(CgPushChevronRightO)]
    CgPushChevronRightO,
    #[cfg(CgPushChevronRightR)]
    CgPushChevronRightR,
    #[cfg(CgPushChevronUp)]
    CgPushChevronUp,
    #[cfg(CgPushChevronUpO)]
    CgPushChevronUpO,
    #[cfg(CgPushChevronUpR)]
    CgPushChevronUpR,
    #[cfg(CgPushDown)]
    CgPushDown,
    #[cfg(CgPushLeft)]
    ...
    #[cfg(CgSleep)]
    CgSleep,
    #[cfg(CgSmartHomeBoiler)]
    CgSmartHomeBoiler,
    #[cfg(CgSmartHomeCooker)]
    CgSmartHomeCooker,
    #[cfg(CgSmartHomeHeat)]
    CgSmartHomeHeat,
    #[cfg(CgSmartHomeLight)]
    CgSmartHomeLight,
    #[cfg(CgSmartHomeRefrigerator)]
    CgSmartHomeRefrigerator,
    #[cfg(CgSmartHomeWashMachine)]
    CgSmartHomeWashMachine,
    #[cfg(CgSmartphone)]
    CgSmartphone,
    #[cfg(CgSmartphoneChip)]
    CgSmartphoneChip,
    #[cfg(CgSmartphoneRam)]
    CgSmartphoneRam,
    #[cfg(CgSmartphoneShake)]
    CgSmartphoneShake,
    #[cfg(CgSmile)]
    CgSmile,
    #[cfg(CgSmileMouthOpen)]
    CgSmileMouthOpen,
    #[cfg(CgSmileNeutral)]
    CgSmileNeutral,
    #[cfg(CgSmileNoMouth)]
    ...
    #[cfg(CgSmileUpside)]
    CgSmileUpside,
    #[cfg(CgSoftwareDownload)]
    CgSoftwareDownload,
    #[cfg(CgSoftwareUpload)]
    CgSoftwareUpload,
    #[cfg(CgSortAz)]
    CgSortAz,
    #[cfg(CgSortZa)]
