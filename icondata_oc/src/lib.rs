...
pub enum OcIcon {
    #[cfg(OcAccessibilityInsetSm)]
    OcAccessibilityInsetSm,
    #[cfg(OcAccessibilitySm)]
    OcAccessibilitySm,
    #[cfg(OcAlertFillLg)]
    OcAlertFillLg,
    #[cfg(OcAlertFillSm)]
    ...
    #[cfg(OcArrowBothSm)]
    OcArrowBothSm,
    #[cfg(OcArrowDownLeftLg)]
    OcArrowDownLeftLg,
    #[cfg(OcArrowDownLeftSm)]
    OcArrowDownLeftSm,
    #[cfg(OcArrowDownLg)]
    OcArrowDownLg,
    #[cfg(OcArrowDownRightLg)]
    OcArrowDownRightLg,
    #[cfg(OcArrowDownRightSm)]
    OcArrowDownRightSm,
    #[cfg(OcArrowDownSm)]
    OcArrowDownSm,
    #[cfg(OcArrowLeftLg)]
    ...
    #[cfg(OcArrowUpLg)]
    OcArrowUpLg,
    #[cfg(OcArrowUpRightLg)]
    OcArrowUpRightLg,
    #[cfg(OcArrowUpRightSm)]
    OcArrowUpRightSm,
    #[cfg(OcArrowUpSm)]
    OcArrowUpSm,
    #[cfg(OcBeakerLg)]
    ...
    #[cfg(OcBookSm)]
    OcBookSm,
    #[cfg(OcBookmarkFillLg)]
    OcBookmarkFillLg,
    #[cfg(OcBookmarkLg)]
    OcBookmarkLg,
    #[cfg(OcBookmarkSlashFillLg)]
    OcBookmarkSlashFillLg,
    #[cfg(OcBookmarkSlashLg)]
    OcBookmarkSlashLg,
    #[cfg(OcBookmarkSlashSm)]
    OcBookmarkSlashSm,
    #[cfg(OcBookmarkSm)]
    OcBookmarkSm,
    #[cfg(OcBriefcaseLg)]
    ...
    #[cfg(OcCalendarSm)]
    OcCalendarSm,
    #[cfg(OcCheckCircleFillLg)]
    OcCheckCircleFillLg,
    #[cfg(OcCheckCircleFillSm)]
    OcCheckCircleFillSm,
    #[cfg(OcCheckCircleFillXs)]
    OcCheckCircleFillXs,
    #[cfg(OcCheckCircleLg)]
    OcCheckCircleLg,
    #[cfg(OcCheckCircleSm)]
    ...
    #[cfg(OcChevronLeftSm)]
    OcChevronLeftSm,
    #[cfg(OcChevronRightLg)]
    OcChevronRightLg,
    #[cfg(OcChevronRightSm)]
    OcChevronRightSm,
    #[cfg(OcChevronRightXs)]
    OcChevronRightXs,
    #[cfg(OcChevronUpLg)]
    OcChevronUpLg,
    #[cfg(OcChevronUpSm)]
    ...
    #[cfg(OcCloudLg)]
    OcCloudLg,
    #[cfg(OcCloudOfflineLg)]
    OcCloudOfflineLg,
    #[cfg(OcCloudOfflineSm)]
    OcCloudOfflineSm,
    #[cfg(OcCloudSm)]
    OcCloudSm,
    #[cfg(OcCodeLg)]
    OcCodeLg,
    #[cfg(OcCodeOfConductLg)]
    OcCodeOfConductLg,
    #[cfg(OcCodeOfConductSm)]
    OcCodeOfConductSm,
    #[cfg(OcCodeReviewLg)]
    OcCodeReviewLg,
    #[cfg(OcCodeReviewSm)]
    ...
    #[cfg(OcCodeSquareSm)]
    OcCodeSquareSm,
    #[cfg(OcCodescanCheckmarkLg)]
    OcCodescanCheckmarkLg,
    #[cfg(OcCodescanCheckmarkSm)]
    ...
    #[cfg(OcColumnsSm)]
    OcColumnsSm,
    #[cfg(OcCommandPaletteLg)]
    OcCommandPaletteLg,
    #[cfg(OcCommandPaletteSm)]
    OcCommandPaletteSm,
    #[cfg(OcCommentDiscussionLg)]
    OcCommentDiscussionLg,
    #[cfg(OcCommentDiscussionSm)]
    ...
    #[cfg(OcContainerSm)]
    OcContainerSm,
    #[cfg(OcCopilotErrorSm)]
    OcCopilotErrorSm,
    #[cfg(OcCopilotLg)]
    OcCopilotLg,
    #[cfg(OcCopilotSm)]
    OcCopilotSm,
    #[cfg(OcCopilotWarningSm)]
    OcCopilotWarningSm,
    #[cfg(OcCopilotXl)]
    OcCopilotXl,
    #[cfg(OcCopilotXxl)]
    ...
    #[cfg(OcCreditCardSm)]
    OcCreditCardSm,
    #[cfg(OcCrossReferenceLg)]
    OcCrossReferenceLg,
    #[cfg(OcCrossReferenceSm)]
    OcCrossReferenceSm,
    #[cfg(OcDashLg)]
    OcDashLg,
    #[cfg(OcDashSm)]
    ...
    #[cfg(OcDependabotSm)]
    OcDependabotSm,
    #[cfg(OcDesktopDownloadLg)]
    OcDesktopDownloadLg,
    #[cfg(OcDesktopDownloadSm)]
    OcDesktopDownloadSm,
    #[cfg(OcDeviceCameraSm)]
    OcDeviceCameraSm,
    #[cfg(OcDeviceCameraVideoLg)]
    OcDeviceCameraVideoLg,
    #[cfg(OcDeviceCameraVideoSm)]
    OcDeviceCameraVideoSm,
    #[cfg(OcDeviceDesktopLg)]
    OcDeviceDesktopLg,
    #[cfg(OcDeviceDesktopSm)]
    OcDeviceDesktopSm,
    #[cfg(OcDeviceMobileLg)]
    OcDeviceMobileLg,
    #[cfg(OcDeviceMobileSm)]
    OcDeviceMobileSm,
    #[cfg(OcDevicesLg)]
    OcDevicesLg,
    #[cfg(OcDevicesSm)]
    ...
    #[cfg(OcDiffSm)]
    OcDiffSm,
    #[cfg(OcDiscussionClosedLg)]
    OcDiscussionClosedLg,
    #[cfg(OcDiscussionClosedSm)]
    OcDiscussionClosedSm,
    #[cfg(OcDiscussionDuplicateLg)]
    OcDiscussionDuplicateLg,
    #[cfg(OcDiscussionDuplicateSm)]
    OcDiscussionDuplicateSm,
    #[cfg(OcDiscussionOutdatedLg)]
    OcDiscussionOutdatedLg,
    #[cfg(OcDiscussionOutdatedSm)]
    ...
    #[cfg(OcEyeSm)]
    OcEyeSm,
    #[cfg(OcFeedDiscussionSm)]
    OcFeedDiscussionSm,
    #[cfg(OcFeedForkedSm)]
    OcFeedForkedSm,
    #[cfg(OcFeedHeartSm)]
    OcFeedHeartSm,
    #[cfg(OcFeedIssueClosedSm)]
    OcFeedIssueClosedSm,
    #[cfg(OcFeedIssueDraftSm)]
    OcFeedIssueDraftSm,
    #[cfg(OcFeedIssueOpenSm)]
    OcFeedIssueOpenSm,
    #[cfg(OcFeedIssueReopenSm)]
    OcFeedIssueReopenSm,
    #[cfg(OcFeedMergedSm)]
    OcFeedMergedSm,
    #[cfg(OcFeedPersonSm)]
    ...
    #[cfg(OcFeedPublicSm)]
    OcFeedPublicSm,
    #[cfg(OcFeedPullRequestClosedSm)]
    OcFeedPullRequestClosedSm,
    #[cfg(OcFeedPullRequestDraftSm)]
    OcFeedPullRequestDraftSm,
    #[cfg(OcFeedPullRequestOpenSm)]
    ...
    #[cfg(OcFileDiffSm)]
    OcFileDiffSm,
    #[cfg(OcFileDirectoryFillLg)]
    OcFileDirectoryFillLg,
    #[cfg(OcFileDirectoryFillSm)]
    OcFileDirectoryFillSm,
    #[cfg(OcFileDirectoryLg)]
    OcFileDirectoryLg,
    #[cfg(OcFileDirectoryOpenFillSm)]
    OcFileDirectoryOpenFillSm,
    #[cfg(OcFileDirectorySm)]
    OcFileDirectorySm,
    #[cfg(OcFileDirectorySymlinkLg)]
    OcFileDirectorySymlinkLg,
    #[cfg(OcFileDirectorySymlinkSm)]
    ...
    #[cfg(OcFileSm)]
    OcFileSm,
    #[cfg(OcFileSubmoduleLg)]
    OcFileSubmoduleLg,
    #[cfg(OcFileSubmoduleSm)]
    OcFileSubmoduleSm,
    #[cfg(OcFileSymlinkFileLg)]
    OcFileSymlinkFileLg,
    #[cfg(OcFileSymlinkFileSm)]
    OcFileSymlinkFileSm,
    #[cfg(OcFileZipLg)]
    OcFileZipLg,
    #[cfg(OcFileZipSm)]
    ...
    #[cfg(OcGitMergeLg)]
    OcGitMergeLg,
    #[cfg(OcGitMergeQueueLg)]
    OcGitMergeQueueLg,
    #[cfg(OcGitMergeQueueSm)]
    OcGitMergeQueueSm,
    #[cfg(OcGitMergeSm)]
    OcGitMergeSm,
    #[cfg(OcGitPullRequestClosedLg)]
    OcGitPullRequestClosedLg,
    #[cfg(OcGitPullRequestClosedSm)]
    OcGitPullRequestClosedSm,
    #[cfg(OcGitPullRequestDraftLg)]
    OcGitPullRequestDraftLg,
    #[cfg(OcGitPullRequestDraftSm)]
    OcGitPullRequestDraftSm,
    #[cfg(OcGitPullRequestLg)]
    OcGitPullRequestLg,
    #[cfg(OcGitPullRequestSm)]
    OcGitPullRequestSm,
    #[cfg(OcGlobeLg)]
    OcGlobeLg,
    #[cfg(OcGlobeSm)]
    ...
    #[cfg(OcHomeSm)]
    OcHomeSm,
    #[cfg(OcHorizontalRuleLg)]
    OcHorizontalRuleLg,
    #[cfg(OcHorizontalRuleSm)]
    OcHorizontalRuleSm,
    #[cfg(OcHourglassLg)]
    OcHourglassLg,
    #[cfg(OcHourglassSm)]
    ...
    #[cfg(OcIssueOpenedSm)]
    OcIssueOpenedSm,
    #[cfg(OcIssueReopenedLg)]
    OcIssueReopenedLg,
    #[cfg(OcIssueReopenedSm)]
    OcIssueReopenedSm,
    #[cfg(OcIssueTrackedByLg)]
    OcIssueTrackedByLg,
    #[cfg(OcIssueTrackedBySm)]
    OcIssueTrackedBySm,
    #[cfg(OcIssueTracksLg)]
    OcIssueTracksLg,
    #[cfg(OcIssueTracksSm)]
    ...
    #[cfg(OcIterationsSm)]
    OcIterationsSm,
    #[cfg(OcKebabHorizontalLg)]
    OcKebabHorizontalLg,
    #[cfg(OcKebabHorizontalSm)]
    OcKebabHorizontalSm,
    #[cfg(OcKeyAsteriskSm)]
    OcKeyAsteriskSm,
    #[cfg(OcKeyLg)]
    ...
    #[cfg(OcLightBulbSm)]
    OcLightBulbSm,
    #[cfg(OcLinkExternalLg)]
    OcLinkExternalLg,
    #[cfg(OcLinkExternalSm)]
    OcLinkExternalSm,
    #[cfg(OcLinkLg)]
    OcLinkLg,
    #[cfg(OcLinkSm)]
    ...
    #[cfg(OcListOrderedSm)]
    OcListOrderedSm,
    #[cfg(OcListUnorderedLg)]
    OcListUnorderedLg,
    #[cfg(OcListUnorderedSm)]
    OcListUnorderedSm,
    #[cfg(OcLocationLg)]
    OcLocationLg,
    #[cfg(OcLocationSm)]
    ...
    #[cfg(OcMortarBoardSm)]
    OcMortarBoardSm,
    #[cfg(OcMoveToBottomLg)]
    OcMoveToBottomLg,
    #[cfg(OcMoveToBottomSm)]
    OcMoveToBottomSm,
    #[cfg(OcMoveToEndLg)]
    OcMoveToEndLg,
    #[cfg(OcMoveToEndSm)]
    ...
    #[cfg(OcNumberSm)]
    OcNumberSm,
    #[cfg(OcOrganizationLg)]
    OcOrganizationLg,
    #[cfg(OcOrganizationSm)]
    OcOrganizationSm,
    #[cfg(OcPackageDependenciesLg)]
    OcPackageDependenciesLg,
    #[cfg(OcPackageDependenciesSm)]
    OcPackageDependenciesSm,
    #[cfg(OcPackageDependentsLg)]
    OcPackageDependentsLg,
    #[cfg(OcPackageDependentsSm)]
    ...
    #[cfg(OcPaintbrushSm)]
    OcPaintbrushSm,
    #[cfg(OcPaperAirplaneLg)]
    OcPaperAirplaneLg,
    #[cfg(OcPaperAirplaneSm)]
    OcPaperAirplaneSm,
    #[cfg(OcPaperclipLg)]
    OcPaperclipLg,
    #[cfg(OcPaperclipSm)]
    ...
    #[cfg(OcProjectLg)]
    OcProjectLg,
    #[cfg(OcProjectRoadmapLg)]
    OcProjectRoadmapLg,
    #[cfg(OcProjectRoadmapSm)]
    OcProjectRoadmapSm,
    #[cfg(OcProjectSm)]
    OcProjectSm,
    #[cfg(OcProjectSymlinkLg)]
    OcProjectSymlinkLg,
    #[cfg(OcProjectSymlinkSm)]
    OcProjectSymlinkSm,
    #[cfg(OcProjectTemplateLg)]
    OcProjectTemplateLg,
    #[cfg(OcProjectTemplateSm)]
    OcProjectTemplateSm,
    #[cfg(OcPulseLg)]
    OcPulseLg,
    #[cfg(OcPulseSm)]
    ...
    #[cfg(OcRepoSm)]
    OcRepoSm,
    #[cfg(OcRepoTemplateLg)]
    OcRepoTemplateLg,
    #[cfg(OcRepoTemplateSm)]
    OcRepoTemplateSm,
    #[cfg(OcReportLg)]
    OcReportLg,
    #[cfg(OcReportSm)]
    ...
    #[cfg(OcScreenFullSm)]
    OcScreenFullSm,
    #[cfg(OcScreenNormalLg)]
    OcScreenNormalLg,
    #[cfg(OcScreenNormalSm)]
    OcScreenNormalSm,
    #[cfg(OcSearchLg)]
    OcSearchLg,
    #[cfg(OcSearchSm)]
    ...
    #[cfg(OcServerSm)]
    OcServerSm,
    #[cfg(OcShareAndroidLg)]
    OcShareAndroidLg,
    #[cfg(OcShareAndroidSm)]
    OcShareAndroidSm,
    #[cfg(OcShareLg)]
    OcShareLg,
    #[cfg(OcShareSm)]
    ...
    #[cfg(OcShieldXSm)]
    OcShieldXSm,
    #[cfg(OcSidebarCollapseLg)]
    OcSidebarCollapseLg,
    #[cfg(OcSidebarCollapseSm)]
    OcSidebarCollapseSm,
    #[cfg(OcSidebarExpandLg)]
    OcSidebarExpandLg,
    #[cfg(OcSidebarExpandSm)]
    OcSidebarExpandSm,
    #[cfg(OcSignInLg)]
    OcSignInLg,
    #[cfg(OcSignInSm)]
    ...
    #[cfg(OcSignOutSm)]
    OcSignOutSm,
    #[cfg(OcSingleSelectLg)]
    OcSingleSelectLg,
    #[cfg(OcSingleSelectSm)]
    OcSingleSelectSm,
    #[cfg(OcSkipFillLg)]
    OcSkipFillLg,
    #[cfg(OcSkipFillSm)]
    ...
    #[cfg(OcSparkleFillSm)]
    OcSparkleFillSm,
    #[cfg(OcSponsorTiersLg)]
    OcSponsorTiersLg,
    #[cfg(OcSponsorTiersSm)]
    OcSponsorTiersSm,
    #[cfg(OcSquareFillLg)]
    OcSquareFillLg,
    #[cfg(OcSquareFillSm)]
    ...
    #[cfg(OcStopwatchSm)]
    OcStopwatchSm,
    #[cfg(OcStrikethroughLg)]
    OcStrikethroughLg,
    #[cfg(OcStrikethroughSm)]
    OcStrikethroughSm,
    #[cfg(OcSunLg)]
    OcSunLg,
    #[cfg(OcSunSm)]
    ...
    #[cfg(OcTasklistSm)]
    OcTasklistSm,
    #[cfg(OcTelescopeFillLg)]
    OcTelescopeFillLg,
    #[cfg(OcTelescopeFillSm)]
    OcTelescopeFillSm,
    #[cfg(OcTelescopeLg)]
    OcTelescopeLg,
    #[cfg(OcTelescopeSm)]
    ...
    #[cfg(OcToolsSm)]
    OcToolsSm,
    #[cfg(OcTrackedByClosedCompletedLg)]
    OcTrackedByClosedCompletedLg,
    #[cfg(OcTrackedByClosedCompletedSm)]
    OcTrackedByClosedCompletedSm,
    #[cfg(OcTrackedByClosedNotPlannedLg)]
    OcTrackedByClosedNotPlannedLg,
    #[cfg(OcTrackedByClosedNotPlannedSm)]
    OcTrackedByClosedNotPlannedSm,
    #[cfg(OcTrashLg)]
    OcTrashLg,
    #[cfg(OcTrashSm)]
    OcTrashSm,
    #[cfg(OcTriangleDownLg)]
    OcTriangleDownLg,
    #[cfg(OcTriangleDownSm)]
    OcTriangleDownSm,
    #[cfg(OcTriangleLeftLg)]
    OcTriangleLeftLg,
    #[cfg(OcTriangleLeftSm)]
    OcTriangleLeftSm,
    #[cfg(OcTriangleRightLg)]
    OcTriangleRightLg,
    #[cfg(OcTriangleRightSm)]
    OcTriangleRightSm,
    #[cfg(OcTriangleUpLg)]
    OcTriangleUpLg,
    #[cfg(OcTriangleUpSm)]
