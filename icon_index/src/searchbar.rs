...
pub fn SearchBar(cx: Scope) -> impl IntoView {
    ...
    view! { cx,
        <div class="relative mx-auto text-gray-600 dark:text-gray-300">
            <input class="appearance-none shadow border-2 border-gray-300
            ...
            <Icon icon=FaIcon::FaMagnifyingGlassSolid class="absolute right-0 top-0 mt-3 mr-4 text-emphasis dark:text-emphasis-dark" />
        </div>
    }
}
