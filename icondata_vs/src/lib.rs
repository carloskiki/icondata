...
pub enum VsIcon {
    ...
    #[cfg(VsArrowBoth)]
    VsArrowBoth,
    #[cfg(VsArrowCircleDown)]
    VsArrowCircleDown,
    #[cfg(VsArrowCircleLeft)]
    VsArrowCircleLeft,
    #[cfg(VsArrowCircleRight)]
    VsArrowCircleRight,
    #[cfg(VsArrowCircleUp)]
    VsArrowCircleUp,
    #[cfg(VsArrowDown)]
    ...
    #[cfg(VsArrowRight)]
    VsArrowRight,
    #[cfg(VsArrowSmallDown)]
    VsArrowSmallDown,
    #[cfg(VsArrowSmallLeft)]
    VsArrowSmallLeft,
    #[cfg(VsArrowSmallRight)]
    VsArrowSmallRight,
    #[cfg(VsArrowSmallUp)]
    VsArrowSmallUp,
    #[cfg(VsArrowSwap)]
    ...
    #[cfg(VsChromeClose)]
    VsChromeClose,
    #[cfg(VsChromeMaximize)]
    VsChromeMaximize,
    #[cfg(VsChromeMinimize)]
    VsChromeMinimize,
    #[cfg(VsChromeRestore)]
    VsChromeRestore,
    #[cfg(VsCircle)]
    ...
    #[cfg(VsCircleLarge)]
    VsCircleLarge,
    #[cfg(VsCircleLargeFilled)]
    VsCircleLargeFilled,
    #[cfg(VsCircleSlash)]
    VsCircleSlash,
    #[cfg(VsCircleSmall)]
    VsCircleSmall,
    #[cfg(VsCircleSmallFilled)]
    VsCircleSmallFilled,
    #[cfg(VsCircuitBoard)]
    VsCircuitBoard,
    #[cfg(VsClearAll)]
    ...
    #[cfg(VsComment)]
    VsComment,
    #[cfg(VsCommentDiscussion)]
    VsCommentDiscussion,
    #[cfg(VsCommentDraft)]
    VsCommentDraft,
    #[cfg(VsCommentUnresolved)]
    VsCommentUnresolved,
    #[cfg(VsCompass)]
    VsCompass,
    #[cfg(VsCompassActive)]
    ...
    #[cfg(VsDebugAltSmall)]
    VsDebugAltSmall,
    #[cfg(VsDebugBreakpointConditional)]
    VsDebugBreakpointConditional,
    #[cfg(VsDebugBreakpointConditionalUnverified)]
    VsDebugBreakpointConditionalUnverified,
    #[cfg(VsDebugBreakpointData)]
    VsDebugBreakpointData,
    #[cfg(VsDebugBreakpointDataUnverified)]
    VsDebugBreakpointDataUnverified,
    #[cfg(VsDebugBreakpointFunction)]
    VsDebugBreakpointFunction,
    #[cfg(VsDebugBreakpointFunctionUnverified)]
    VsDebugBreakpointFunctionUnverified,
    #[cfg(VsDebugBreakpointLog)]
    VsDebugBreakpointLog,
    #[cfg(VsDebugBreakpointLogUnverified)]
    VsDebugBreakpointLogUnverified,
    #[cfg(VsDebugBreakpointUnsupported)]
    VsDebugBreakpointUnsupported,
    #[cfg(VsDebugConsole)]
    VsDebugConsole,
    #[cfg(VsDebugContinue)]
    VsDebugContinue,
    #[cfg(VsDebugContinueSmall)]
    VsDebugContinueSmall,
    #[cfg(VsDebugCoverage)]
    VsDebugCoverage,
    #[cfg(VsDebugDisconnect)]
    VsDebugDisconnect,
    #[cfg(VsDebugLineByLine)]
    VsDebugLineByLine,
    #[cfg(VsDebugPause)]
    VsDebugPause,
    #[cfg(VsDebugRerun)]
    ...
    #[cfg(VsDebugRestart)]
    VsDebugRestart,
    #[cfg(VsDebugRestartFrame)]
    VsDebugRestartFrame,
    #[cfg(VsDebugReverseContinue)]
    VsDebugReverseContinue,
    #[cfg(VsDebugStackframe)]
    VsDebugStackframe,
    #[cfg(VsDebugStackframeActive)]
    ...
    #[cfg(VsDebugStop)]
    VsDebugStop,
    #[cfg(VsDesktopDownload)]
    VsDesktopDownload,
    #[cfg(VsDeviceCamera)]
    VsDeviceCamera,
    #[cfg(VsDeviceCameraVideo)]
    VsDeviceCameraVideo,
    #[cfg(VsDeviceMobile)]
    VsDeviceMobile,
    #[cfg(VsDiff)]
    ...
    #[cfg(VsFileSubmodule)]
    VsFileSubmodule,
    #[cfg(VsFileSymlinkDirectory)]
    VsFileSymlinkDirectory,
    #[cfg(VsFileSymlinkFile)]
    VsFileSymlinkFile,
    #[cfg(VsFileZip)]
    VsFileZip,
    #[cfg(VsFiles)]
    ...
    #[cfg(VsGitMerge)]
    VsGitMerge,
    #[cfg(VsGitPullRequest)]
    VsGitPullRequest,
    #[cfg(VsGitPullRequestClosed)]
    VsGitPullRequestClosed,
    #[cfg(VsGitPullRequestCreate)]
    VsGitPullRequestCreate,
    #[cfg(VsGitPullRequestDraft)]
    VsGitPullRequestDraft,
    #[cfg(VsGitPullRequestGoToChanges)]
    VsGitPullRequestGoToChanges,
    #[cfg(VsGitPullRequestNewChanges)]
    ...
    #[cfg(VsLayout)]
    VsLayout,
    #[cfg(VsLayoutActivitybarLeft)]
    VsLayoutActivitybarLeft,
    #[cfg(VsLayoutActivitybarRight)]
    VsLayoutActivitybarRight,
    #[cfg(VsLayoutCentered)]
    VsLayoutCentered,
    #[cfg(VsLayoutMenubar)]
    VsLayoutMenubar,
    #[cfg(VsLayoutPanel)]
    VsLayoutPanel,
    #[cfg(VsLayoutPanelCenter)]
    VsLayoutPanelCenter,
    #[cfg(VsLayoutPanelJustify)]
    VsLayoutPanelJustify,
    #[cfg(VsLayoutPanelLeft)]
    VsLayoutPanelLeft,
    #[cfg(VsLayoutPanelOff)]
    VsLayoutPanelOff,
    #[cfg(VsLayoutPanelRight)]
    VsLayoutPanelRight,
    #[cfg(VsLayoutSidebarLeft)]
    VsLayoutSidebarLeft,
    #[cfg(VsLayoutSidebarLeftOff)]
    VsLayoutSidebarLeftOff,
    #[cfg(VsLayoutSidebarRight)]
    VsLayoutSidebarRight,
    #[cfg(VsLayoutSidebarRightOff)]
    VsLayoutSidebarRightOff,
    #[cfg(VsLayoutStatusbar)]
    VsLayoutStatusbar,
    #[cfg(VsLibrary)]
    VsLibrary,
    #[cfg(VsLightbulb)]
    VsLightbulb,
    #[cfg(VsLightbulbAutofix)]
    VsLightbulbAutofix,
    #[cfg(VsLink)]
    VsLink,
    #[cfg(VsLinkExternal)]
    ...
    #[cfg(VsReport)]
    VsReport,
    #[cfg(VsRequestChanges)]
    VsRequestChanges,
    #[cfg(VsRocket)]
    VsRocket,
    #[cfg(VsRootFolder)]
    VsRootFolder,
    #[cfg(VsRootFolderOpened)]
    VsRootFolderOpened,
    #[cfg(VsRss)]
    VsRss,
    #[cfg(VsRuby)]
    ...
    #[cfg(VsSmiley)]
    VsSmiley,
    #[cfg(VsSortPrecedence)]
    VsSortPrecedence,
    #[cfg(VsSourceControl)]
    VsSourceControl,
    #[cfg(VsSparkle)]
    VsSparkle,
    #[cfg(VsSplitHorizontal)]
    VsSplitHorizontal,
    #[cfg(VsSplitVertical)]
    VsSplitVertical,
    #[cfg(VsSquirrel)]
    ...
    #[cfg(VsSymbolColor)]
    VsSymbolColor,
    #[cfg(VsSymbolConstant)]
    VsSymbolConstant,
    #[cfg(VsSymbolEnum)]
    VsSymbolEnum,
    #[cfg(VsSymbolEnumMember)]
    VsSymbolEnumMember,
    #[cfg(VsSymbolEvent)]
    VsSymbolEvent,
    #[cfg(VsSymbolField)]
    ...
    #[cfg(VsSymbolMisc)]
    VsSymbolMisc,
    #[cfg(VsSymbolNamespace)]
    VsSymbolNamespace,
    #[cfg(VsSymbolNumeric)]
    VsSymbolNumeric,
    #[cfg(VsSymbolOperator)]
    VsSymbolOperator,
    #[cfg(VsSymbolParameter)]
    VsSymbolParameter,
    #[cfg(VsSymbolProperty)]
    VsSymbolProperty,
    #[cfg(VsSymbolRuler)]
    VsSymbolRuler,
    #[cfg(VsSymbolSnippet)]
    ...
    #[cfg(VsSymbolString)]
    VsSymbolString,
    #[cfg(VsSymbolStructure)]
    VsSymbolStructure,
    #[cfg(VsSymbolVariable)]
    VsSymbolVariable,
    #[cfg(VsSync)]
    VsSync,
    #[cfg(VsSyncIgnored)]
    ...
    #[cfg(VsTerminalCmd)]
    VsTerminalCmd,
    #[cfg(VsTerminalDebian)]
    VsTerminalDebian,
    #[cfg(VsTerminalLinux)]
    VsTerminalLinux,
    #[cfg(VsTerminalPowershell)]
    VsTerminalPowershell,
    #[cfg(VsTerminalTmux)]
    VsTerminalTmux,
    #[cfg(VsTerminalUbuntu)]
    VsTerminalUbuntu,
    #[cfg(VsTextSize)]
    VsTextSize,
    #[cfg(VsThreeBars)]
    ...
    #[cfg(VsTypeHierarchy)]
    VsTypeHierarchy,
    #[cfg(VsTypeHierarchySub)]
    VsTypeHierarchySub,
    #[cfg(VsTypeHierarchySuper)]
    VsTypeHierarchySuper,
    #[cfg(VsUnfold)]
    VsUnfold,
    #[cfg(VsUngroupByRefType)]
    VsUngroupByRefType,
    #[cfg(VsUnlock)]
    VsUnlock,
    #[cfg(VsUnmute)]
    ...
    #[cfg(VsWordWrap)]
    VsWordWrap,
    #[cfg(VsWorkspaceTrusted)]
    VsWorkspaceTrusted,
    #[cfg(VsWorkspaceUnknown)]
    VsWorkspaceUnknown,
    #[cfg(VsWorkspaceUntrusted)]
