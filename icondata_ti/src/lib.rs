...
pub enum TiIcon {
    #[cfg(TiAdjustBrightness)]
    TiAdjustBrightness,
    #[cfg(TiAdjustContrast)]
    TiAdjustContrast,
    #[cfg(TiAnchor)]
    TiAnchor,
    #[cfg(TiAnchorOutline)]
    ...
    #[cfg(TiArrowBack)]
    TiArrowBack,
    #[cfg(TiArrowBackOutline)]
    TiArrowBackOutline,
    #[cfg(TiArrowDown)]
    TiArrowDown,
    #[cfg(TiArrowDownOutline)]
    TiArrowDownOutline,
    #[cfg(TiArrowDownThick)]
    TiArrowDownThick,
    #[cfg(TiArrowForward)]
    TiArrowForward,
    #[cfg(TiArrowForwardOutline)]
    TiArrowForwardOutline,
    #[cfg(TiArrowLeft)]
    TiArrowLeft,
    #[cfg(TiArrowLeftOutline)]
    TiArrowLeftOutline,
    #[cfg(TiArrowLeftThick)]
    TiArrowLeftThick,
    #[cfg(TiArrowLoop)]
    TiArrowLoop,
    #[cfg(TiArrowLoopOutline)]
    TiArrowLoopOutline,
    #[cfg(TiArrowMaximise)]
    TiArrowMaximise,
    #[cfg(TiArrowMaximiseOutline)]
    TiArrowMaximiseOutline,
    #[cfg(TiArrowMinimise)]
    TiArrowMinimise,
    #[cfg(TiArrowMinimiseOutline)]
    TiArrowMinimiseOutline,
    #[cfg(TiArrowMove)]
    TiArrowMove,
    #[cfg(TiArrowMoveOutline)]
    TiArrowMoveOutline,
    #[cfg(TiArrowRepeat)]
    TiArrowRepeat,
    #[cfg(TiArrowRepeatOutline)]
    TiArrowRepeatOutline,
    #[cfg(TiArrowRight)]
    TiArrowRight,
    #[cfg(TiArrowRightOutline)]
    TiArrowRightOutline,
    #[cfg(TiArrowRightThick)]
    TiArrowRightThick,
    #[cfg(TiArrowShuffle)]
    TiArrowShuffle,
    #[cfg(TiArrowSortedDown)]
    TiArrowSortedDown,
    #[cfg(TiArrowSortedUp)]
    TiArrowSortedUp,
    #[cfg(TiArrowSync)]
    TiArrowSync,
    #[cfg(TiArrowSyncOutline)]
    TiArrowSyncOutline,
    #[cfg(TiArrowUnsorted)]
    TiArrowUnsorted,
    #[cfg(TiArrowUp)]
    TiArrowUp,
    #[cfg(TiArrowUpOutline)]
    TiArrowUpOutline,
    #[cfg(TiArrowUpThick)]
    TiArrowUpThick,
    #[cfg(TiAt)]
    ...
    #[cfg(TiAttachment)]
    TiAttachment,
    #[cfg(TiAttachmentOutline)]
    TiAttachmentOutline,
    #[cfg(TiBackspace)]
    TiBackspace,
    #[cfg(TiBackspaceOutline)]
    TiBackspaceOutline,
    #[cfg(TiBatteryCharge)]
    TiBatteryCharge,
    #[cfg(TiBatteryFull)]
    ...
    #[cfg(TiChartArea)]
    TiChartArea,
    #[cfg(TiChartAreaOutline)]
    TiChartAreaOutline,
    #[cfg(TiChartBar)]
    TiChartBar,
    #[cfg(TiChartBarOutline)]
    TiChartBarOutline,
    #[cfg(TiChartLine)]
    TiChartLine,
    #[cfg(TiChartLineOutline)]
    TiChartLineOutline,
    #[cfg(TiChartPie)]
    TiChartPie,
    #[cfg(TiChartPieOutline)]
    TiChartPieOutline,
    #[cfg(TiChevronLeft)]
    TiChevronLeft,
    #[cfg(TiChevronLeftOutline)]
    TiChevronLeftOutline,
    #[cfg(TiChevronRight)]
    TiChevronRight,
    #[cfg(TiChevronRightOutline)]
    TiChevronRightOutline,
    #[cfg(TiClipboard)]
    TiClipboard,
    #[cfg(TiCloudStorage)]
    TiCloudStorage,
    #[cfg(TiCloudStorageOutline)]
    ...
    #[cfg(TiDocumentAdd)]
    TiDocumentAdd,
    #[cfg(TiDocumentDelete)]
    TiDocumentDelete,
    #[cfg(TiDocumentText)]
    TiDocumentText,
    #[cfg(TiDownload)]
    TiDownload,
    #[cfg(TiDownloadOutline)]
    TiDownloadOutline,
    #[cfg(TiDropbox)]
    TiDropbox,
    #[cfg(TiEdit)]
    ...
    #[cfg(TiHeart)]
    TiHeart,
    #[cfg(TiHeartFullOutline)]
    TiHeartFullOutline,
    #[cfg(TiHeartHalfOutline)]
    TiHeartHalfOutline,
    #[cfg(TiHeartOutline)]
    TiHeartOutline,
    #[cfg(TiHome)]
    ...
    #[cfg(TiInfinity)]
    TiInfinity,
    #[cfg(TiInfinityOutline)]
    TiInfinityOutline,
    #[cfg(TiInfo)]
    TiInfo,
    #[cfg(TiInfoLarge)]
    TiInfoLarge,
    #[cfg(TiInfoLargeOutline)]
    TiInfoLargeOutline,
    #[cfg(TiInfoOutline)]
    TiInfoOutline,
    #[cfg(TiInputChecked)]
    TiInputChecked,
    #[cfg(TiInputCheckedOutline)]
    ...
    #[cfg(TiLocationArrow)]
    TiLocationArrow,
    #[cfg(TiLocationArrowOutline)]
    TiLocationArrowOutline,
    #[cfg(TiLocationOutline)]
    TiLocationOutline,
    #[cfg(TiLockClosed)]
    TiLockClosed,
    #[cfg(TiLockClosedOutline)]
    TiLockClosedOutline,
    #[cfg(TiLockOpen)]
    TiLockOpen,
    #[cfg(TiLockOpenOutline)]
    TiLockOpenOutline,
    #[cfg(TiMail)]
    TiMail,
    #[cfg(TiMap)]
    ...
    #[cfg(TiMediaEject)]
    TiMediaEject,
    #[cfg(TiMediaEjectOutline)]
    TiMediaEjectOutline,
    #[cfg(TiMediaFastForward)]
    TiMediaFastForward,
    #[cfg(TiMediaFastForwardOutline)]
    TiMediaFastForwardOutline,
    #[cfg(TiMediaPause)]
    TiMediaPause,
    #[cfg(TiMediaPauseOutline)]
    TiMediaPauseOutline,
    #[cfg(TiMediaPlay)]
    TiMediaPlay,
    #[cfg(TiMediaPlayOutline)]
    TiMediaPlayOutline,
    #[cfg(TiMediaPlayReverse)]
    TiMediaPlayReverse,
    #[cfg(TiMediaPlayReverseOutline)]
    TiMediaPlayReverseOutline,
    #[cfg(TiMediaRecord)]
    TiMediaRecord,
    #[cfg(TiMediaRecordOutline)]
    TiMediaRecordOutline,
    #[cfg(TiMediaRewind)]
    TiMediaRewind,
    #[cfg(TiMediaRewindOutline)]
    TiMediaRewindOutline,
    #[cfg(TiMediaStop)]
    TiMediaStop,
    #[cfg(TiMediaStopOutline)]
    TiMediaStopOutline,
    #[cfg(TiMessage)]
    TiMessage,
    #[cfg(TiMessageTyping)]
    ...
    #[cfg(TiPlusOutline)]
    TiPlusOutline,
    #[cfg(TiPointOfInterest)]
    TiPointOfInterest,
    #[cfg(TiPointOfInterestOutline)]
    ...
    #[cfg(TiScissors)]
    TiScissors,
    #[cfg(TiScissorsOutline)]
    TiScissorsOutline,
    #[cfg(TiShoppingBag)]
    TiShoppingBag,
    #[cfg(TiShoppingCart)]
    TiShoppingCart,
    #[cfg(TiSocialAtCircular)]
    TiSocialAtCircular,
    #[cfg(TiSocialDribbble)]
    TiSocialDribbble,
    #[cfg(TiSocialDribbbleCircular)]
    TiSocialDribbbleCircular,
    #[cfg(TiSocialFacebook)]
    TiSocialFacebook,
    #[cfg(TiSocialFacebookCircular)]
    TiSocialFacebookCircular,
    #[cfg(TiSocialFlickr)]
    TiSocialFlickr,
    #[cfg(TiSocialFlickrCircular)]
    TiSocialFlickrCircular,
    #[cfg(TiSocialGithub)]
    TiSocialGithub,
    #[cfg(TiSocialGithubCircular)]
    TiSocialGithubCircular,
    #[cfg(TiSocialGooglePlus)]
    TiSocialGooglePlus,
    #[cfg(TiSocialGooglePlusCircular)]
    TiSocialGooglePlusCircular,
    #[cfg(TiSocialInstagram)]
    TiSocialInstagram,
    #[cfg(TiSocialInstagramCircular)]
    TiSocialInstagramCircular,
    #[cfg(TiSocialLastFm)]
    TiSocialLastFm,
    #[cfg(TiSocialLastFmCircular)]
    TiSocialLastFmCircular,
    #[cfg(TiSocialLinkedin)]
    TiSocialLinkedin,
    #[cfg(TiSocialLinkedinCircular)]
    TiSocialLinkedinCircular,
    #[cfg(TiSocialPinterest)]
    TiSocialPinterest,
    #[cfg(TiSocialPinterestCircular)]
    TiSocialPinterestCircular,
    #[cfg(TiSocialSkype)]
    TiSocialSkype,
    #[cfg(TiSocialSkypeOutline)]
    TiSocialSkypeOutline,
    #[cfg(TiSocialTumbler)]
    TiSocialTumbler,
    #[cfg(TiSocialTumblerCircular)]
    TiSocialTumblerCircular,
    #[cfg(TiSocialTwitter)]
    TiSocialTwitter,
    #[cfg(TiSocialTwitterCircular)]
    TiSocialTwitterCircular,
    #[cfg(TiSocialVimeo)]
    TiSocialVimeo,
    #[cfg(TiSocialVimeoCircular)]
    TiSocialVimeoCircular,
    #[cfg(TiSocialYoutube)]
    TiSocialYoutube,
    #[cfg(TiSocialYoutubeCircular)]
    TiSocialYoutubeCircular,
    #[cfg(TiSortAlphabetically)]
    TiSortAlphabetically,
    #[cfg(TiSortAlphabeticallyOutline)]
    TiSortAlphabeticallyOutline,
    #[cfg(TiSortNumerically)]
    TiSortNumerically,
    #[cfg(TiSortNumericallyOutline)]
    TiSortNumericallyOutline,
    #[cfg(TiSpanner)]
    TiSpanner,
    #[cfg(TiSpannerOutline)]
    TiSpannerOutline,
    #[cfg(TiSpiral)]
    TiSpiral,
    #[cfg(TiStar)]
    TiStar,
    #[cfg(TiStarFullOutline)]
    TiStarFullOutline,
    #[cfg(TiStarHalf)]
    TiStarHalf,
    #[cfg(TiStarHalfOutline)]
    TiStarHalfOutline,
    #[cfg(TiStarOutline)]
    TiStarOutline,
    #[cfg(TiStarburst)]
    TiStarburst,
    #[cfg(TiStarburstOutline)]
    TiStarburstOutline,
    #[cfg(TiStopwatch)]
    TiStopwatch,
    #[cfg(TiSupport)]
    ...
    #[cfg(TiUserAdd)]
    TiUserAdd,
    #[cfg(TiUserAddOutline)]
    TiUserAddOutline,
    #[cfg(TiUserDelete)]
    TiUserDelete,
    #[cfg(TiUserDeleteOutline)]
    TiUserDeleteOutline,
    #[cfg(TiUserOutline)]
    TiUserOutline,
    #[cfg(TiVendorAndroid)]
    ...
    #[cfg(TiWeatherCloudy)]
    TiWeatherCloudy,
    #[cfg(TiWeatherDownpour)]
    TiWeatherDownpour,
    #[cfg(TiWeatherNight)]
    TiWeatherNight,
    #[cfg(TiWeatherPartlySunny)]
